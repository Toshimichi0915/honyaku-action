  ...
  "node_modules/.pnpm/adm-zip@0.5.16/node_modules/adm-zip/util/utils.js"(exports2, module2) {
    ...
    Utils.prototype.writeFileTo = function(path2, content, overwrite, attr) {
      ...
      if (self.fs.existsSync(path2)) {
        ...
        var stat2 = self.fs.statSync(path2);
    ...
    Utils.prototype.writeFileToAsync = function(path2, content, overwrite, attr, callback) {
      ...
      self.fs.exists(path2, function(exist) {
        ...
        self.fs.stat(path2, function(err, stat2) {
...
var locales_default = [
  ...
  },
  {
    id: "tr",
    name: "Turkish",
    endonym: "T\xFCrk\xE7e",
    bcp47: "tr-TR"
  },
  {
    id: "tk",
    name: "Turkmen",
    endonym: "t\xFCrkmen dili",
    bcp47: "tk-TM"
  },
  {
    id: "tw",
...
async function main() {
  const sourceFile = getInput("source-file");
  ...
  while (status != "completed") {
    ...
    info(`Translation job status: ${status}, remaining: ${result.remaining}`);
    if (status === "failed") {
